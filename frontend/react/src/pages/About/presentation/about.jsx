...
const solutionStatement =
  'SmartFarm-Market is an online platform that bridges the gap between local vegetable sellers, farmers, and consumers. It provides a convenient and transparent marketplace where consumers can easily access a wide variety of fresh and locally grown vegetables. By eliminating intermediaries, FreshNest empowers local farmers and sellers to showcase their produce directly to customers, enabling a direct farm-to-table connection. ';
      ...
      <main className="mt-[8vh]">
        <section className=" flex flex-col-reverse md:flex-row ">
          <div className="flex flex-col w-[100%] md:w-[50%] justify-center px-5 md:px-20 md:py-20">
            ...
            <p className="leading-relaxed text-semiDarkColor">{problemStatement}</p>
          </div>
          <motion.img
      ...
      <main className="mt-[8vh] mb-5">
        <section className=" flex flex-col md:flex-row">
          ...
          <div className="flex flex-col w-[100%] md:w-[50%] justify-center px-5 md:px-20">
            ...
            <p className="leading-relaxed text-semiDarkColor">{solutionStatement}</p>
          </div>
        </section>
      </main>
